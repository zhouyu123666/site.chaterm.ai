...
Welcome to use Chaterm, which is provided by INTSIG PTE. LTD. Chaterm is an intelligent terminal tool powered by an AI agent. It combines AI capabilities with traditional terminal functions. This tool aims to simplify complex terminal operations by allowing you to interact using natural language, eliminating the need to memorize complex command syntax across different operating systems.We are committed to protecting the privacy of your data. This Privacy Policy explains how we collect information about you; how we maintain, use, and share that information; and how you can manage the way information about you is handled when you access or use our websites and applications (collectively, “Services”).
...
(a) Personal Data that you voluntarily provide to us: We collect Personal Data if you use our Services or communicate with us as follows:

Login Options:You may access our Services by signing in through your e-mail , iOS account or Google account. When using these third-party login methods, we only receive basic profile information (e.g., username or email address) required for authentication, as permitted by the respective platform.

User Content: In order to provide Chaterm DevOps Services, we collect server host IP address, port, and login password that you provide to our Services. The Personal Data we collect cannot be used for identifying a specific person. When the service is finished or upon the closing of the application, the personal data are discarded.
...
Collection of Voice Content: During your use of voice input, we process audio data captured by the microphone in real-time. This audio data contains the speech content of your utterances, which is converted into text or directly used as commands to engage the large language model for analysis and to generate corresponding feedback for you. The core of our collection and processing is the linguistic information contained within the speech, aimed at understanding your intent and providing the service

Important Clarification: No Collection of Voiceprint Information: We expressly state that in this process, we do not intentionally identify, extract, or collect any voiceprint information(e.g., information reflecting the physical characteristics of your voice) that could be used to identify your unique biological characteristics. Our system is designed to process the language content itself, not to analyze the individual characteristics of the voice.

(b) Personal Data We Receive from Your Use of the Services: When you visit, use, or interact with the Services, we receive the following information about your visit, use, or interactions (“Technical Information”):

Device data. To ensure the basic security of your account, network access and services, we need to collect your unique device identifiers (Android ID, IDFV,OAID), country, city, IP address, network access method, network quality data, and obtain Chaterm process information.

Usage Data: We collect information about your use of the Services, such as the types of content that you view or engage with, the features you use and the actions you take, as well as your time zone, country, the dates and times of access.

Access to Device Permissions. To receive your voice commands, this feature requires access to and use of the microphone permission on your device.

When you use the AI command completion and suggestion features, we will collect and store your frequently used command history in server operation scenarios (including but not limited to command line statements, operation parameters, and execution log summaries). Such information is only used to remember your operation habits across sessions, enable quick command invocation, grammar error correction, scenario-based recommendations and troubleshooting assistance, and improve server management efficiency. You may disable this feature via Settings - Extensions by turning off automatic completion.

2.How we use your data?

We may use Personal Data for the following purposes:

(a)To provide analyze, and maintain our Services, for example to translate the content you uploaded;

(b)To improve and develop our Services, but we will not use Personal Data to train our models;

(c)To enhance the safety and security of our Services and to help us detect abuse, fraud, and illegal activity in our Services;

(d)To communicate with you, including to notify you about changes in our Services;
...
4.2 To store your personal data, we entrust data hosting services provided by Amazon Web Services, Inc. (a subsidiary of Amazon.com Inc.) or other third-party cloud service providers that have adopted technical and organizational measures to protect your personal data against unauthorized/unlawful processing and accidental loss, destruction or other damage. We take your privacy seriously and, therefore, encrypt your personal data – if possible – before sending it to the hosting organizations for the purposes of its storage.
...
4.3 We’ll retain your Personal Data for only as long as we need in order to provide our Services to you, or for other legitimate business purposes such as resolving disputes, safety and security reasons, or complying with our legal obligations. Once the retention period expires, we will delete or anonymize your data, unless otherwise required by applicable laws and regulations.

5. How we Share and Disclose Personal Data

5.1Sharing

We do not share Personal Data to third parties except as specified below, or where you otherwise consent. We share Personal Data with third parties, including:
...
We may disclose Personal Data without consent in the following cases: (i) to comply with a legal obligation or request, such as a court order, subpoena or other legal process; (ii) as part of a legal sale or corporate transaction, including a sale in bankruptcy; (iii) to enforce our terms; (iv) to address issues relating to security or fraud; or (v) to protect our rights or the rights of others.

6.What Are Your Rights And Choices

You can control and manage your data, you have the following rights and choices:

(a) Access, Correction, and Portability. You have the right to receive a copy of certain of your data in a structured, commonly used and machine-readable format. If you need to do so, please contact us.
...
Our services are not intended for anyone under 16 (or otherwise provided by the related jurisdiction). And that’s why we do not knowingly collect personal information from anyone under 16 (or otherwise provided by the related jurisdiction). We understands the importance of safeguarding the personal information of children, which we consider to be an individual under the age of 16 or the equivalent age as specified by law in your jurisdiction. If you are a child under 16 (or otherwise provided by the related jurisdiction), you are not permitted to use Our services, unless your parent provides verifiable consent. Please contact our Data Protection Officer via email at support@chaterm.ai. if you believe we have any personal information from any Child without such parental/guardian consent and acknowledgment so that we can promptly investigate and remove such personal information.
...
The types of personal information we collect are detailed in “1.What data do we collect? ” .
...
(a)The right to request disclosure of our data collection and sales practices in connection with your personal information, including the categories of personal information we have collected, the source of the information, our use of the information and, if the information was disclosed or sold to third parties, the categories of personal information disclosed or sold to third parties and the categories of third parties to whom such information was disclosed or sold;

(b)The right to request a copy of the specific personal information collected about you during the 12 months before your request (together with right listed above, a “personal information request”);

(c)The right to have such information deleted (excepting where such information is required to: i.provide you with goods or services you requested; ii. detect or resolve issues security or functionality-related issues; iii. comply with the law; iv. conduct research in the public interest; v. safeguard the right to free speech; and vi. carry out any actions for internal purposes that you might reasonably expect).

(d)The right to request that your personal information not be sold to third parties, if applicable.

(e)The right not to be discriminated against because you exercised any of the new rights.
...
If you don’t want us to collect and/or process your information any more please contact us at support@chaterm.ai. Note that if you decide to opt out of data collection and processing this can affect some functions and you may not be able to use all features of Our Services to the fullest extent possible.

How can You submit a personal information request?

You can submit a personal information request via email at support@chaterm.ai.
...
If you make a request regarding your rights, we have one month to respond to you. If you would like to exercise any of the above rights, you can contact us via email at support@chaterm.ai.

Legal basis of processing your personal information

Besides obtaining your consent, we may process information if one of the following applies:
...
If you have any questions about this privacy policy or if you would like to exercise any of your rights, you may contact our Data Protection Officer via email at support@chaterm.ai.
...
(a)obtain confirmation of the existence of processing activities on your personal information;

(b)access your personal information;

(c)have incomplete, inaccurate or outdated personal information rectified;

(d)obtain the anonymization, blocking or elimination of your unnecessary or excessive personal information including information that is not being processed in compliance with the LGPD;

(e) obtain information on the options to provide or deny your consent and the consequences thereof;

(f) obtain information about the third parties with whom we share your personal information;

(g) obtain, upon your express request, the portability of your personal information (except for anonymized information) to another service or product provider, provided that our commercial and industrial secrets are safeguarded;

(h) obtain the deletion of your personal information being processed if the processing was based upon your consent, unless one or more exceptions provided for in Article 16 of the LGPD apply;

(i) revoke your consent at any time;

(j) file a complaint related to your personal information with the Brazilan National Data Protection Authority (Autoridade Nacional de Proteção de Dados or “ANPD”);

(k)oppose a processing activity in cases where the processing is not carried out in compliance with the law;

(l)request clear and adequate information regarding the criteria and procedures used for an automated decision; and

(m)request the review of decisions made solely on the basis of the automated processing of your personal information, which affect your interests, if applicable.
...
(a)when the transfer is necessary for international legal cooperation between public intelligence, investigation and prosecution bodies, according to the legal means provided by the international law;

(b)when the transfer is necessary to protect your life or physical security or those of a third party;

(c)when the transfer is authorized by the Brazilan National Data Protection Authority (Autoridade Nacional de Proteção de Dados or “ANPD”);;
...
(f)when the transfer is necessary for compliance with a legal or regulatory obligation, the carrying out of a contract or preliminary procedures related to a contract, or the regular exercise of rights in judicial, administrative or arbitration procedures.
